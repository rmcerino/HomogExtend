...
control_omi <- function(datos, base_tc, umbral, dist_lw, fecha_desde, fecha_hasta){
  ...
  desde = paste(fecha_desde, " 00:00:01") # Esto lo pongo porque la fecha est� en formato POSIXct y hay que completar el campo con hora, minutos y segundos. Por defecto lo fijamos al inicio del primer d�a y al final del �ltimo.
